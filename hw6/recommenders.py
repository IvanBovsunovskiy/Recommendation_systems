...
class MainRecommender:
    ...
    def __init__(self, data: pd.DataFrame, weighting: bool = True, num_threads: int = 4):
        ...
        self.model = self.fit(self.user_item_matrix, self.num_threads)
    ...
    @staticmethod
    def fit(user_item_matrix, num_threads, n_factors=20, regularization=0.001, iterations=15):
        """Обучает ALS"""
